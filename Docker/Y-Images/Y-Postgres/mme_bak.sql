...
--
-- Name: mme; Type: DATABASE; Schema: -; Owner: postgres
--

CREATE DATABASE mme WITH TEMPLATE = template0 ENCODING = 'UTF8' LC_COLLATE = 'en_US.UTF-8' LC_CTYPE = 'en_US.UTF-8';


ALTER DATABASE mme OWNER TO postgres;
...
SELECT pg_catalog.setval('public.names_id_seq', 4, true);
